...
<html>
  <head>
    ...
    <title>Recibo direcionato a {{ $emailData['clienteNome'] }}</title>
    <style>
                    ...
                    <tr>
                      <td style="font-family: sans-serif; font-size: 14px; vertical-align: top;" valign="top">
                        <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px;">
                            Olá {{ $emailData['clienteNome'] }},</p><p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px;">
                            Estamos enviando seu comporvante de compra do produto {{ $emailData['produtoName'] }}</p>
                        ...
                        <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px;">
                           Aqui temos mais detalhes sobre sua compra.</p><p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; margin-bottom: 15px;">
                            Boa sorte e tenha um bom trabalho/p>
                      </td>
                    </tr>
                  </table>
                </td>
