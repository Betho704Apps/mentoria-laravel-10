    ...
    <div class="col-sm-6">
      <div class="card">
        <div class="card-body">
          ...
          <a href="{{ route('clientes.index')}}" class="btn btn-primary">{{ $TotalClientesCadastrados}}</a>
        </div>
      </div>
    </div>
  </div>  
    ...
    <div class="col-sm-6 mb-3 mb-sm-0">
      <div class="card">
        <div class="card-body">
          ...
          <a href="{{ route('vendas.index')}}" class="btn btn-primary">{{ $TotalVendasCadastrados }}</a>
        </div>
      </div>
    </div>
    <div class="col-sm-6">
      <div class="card">
        <div class="card-body">
          ...
          <a href="{{ route('usuarios.index')}}" class="btn btn-primary">{{ $TotalUsuariosCadastrados }}</a>
        </div>
      </div>
    </div>
  </div>  
